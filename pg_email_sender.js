...
var get_proshow_transactions = {
    ...
    "args":{
        ...
        "columns":["hasura_id","ticket_data","order_id","payment_id"]
    }
}
var hasura_id_email={}
var hasura_ids=[]
...
function start_sending_emails(index){
    var email = actual_data[index].email
    ...
    var qr_png = QRCode.image(signature.toString(), { type: 'png' });
